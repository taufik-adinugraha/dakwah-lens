...
- High-profile corruption cases and court proceedings — Roy Suryo / Dr. Tifa ijazah Jokowi case, Nadiem Makarim Chromebook trial, BGN tersangka Dadan Hindayana / Sony Sanjaya / Lodewyk Pusung penggeledahan Kejagung, Silmy Karim OTT KPK, Wamenaker Noel vonis, Andrie Yunus air keras case — → "Hukum & Keadilan", NOT "Lainnya" and NOT "Pemerintahan & Kebijakan". The criminal proceeding IS the story, even when the defendant is a current/former minister.
