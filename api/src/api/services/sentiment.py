...
- PERSONAL JOB-SEEKING / CAREER-ANXIETY VENTS (added 2026-06-25 after audit#77 found 19 X-platform bleeds — mostly Ekonomi→Lainnya + Pekerja→Lainnya). X surfaces a heavy stream of FIRST-PERSON career/job-seeking posts that are personal venting, NOT economic or labor-rights analysis: "fresh-grad cari kerja susah", "udah 25 tahun belum dapat kerja", "gagal seleksi Alfamart, ada info loker?", casual polls ("susah cari kerja atau bertahan di kerjaan toxic?"), "manifest" wishlists about an ideal job, memes about karyawan/dewasa life-stages, freelance-cuan promo/tips threads, job-fair promo ads, loker ad reposts. → "Lainnya". These are NOT "Ekonomi & Bisnis" (no stocks/IHSG/corporate-finance/business-regulation — a personal cari-kerja lament is not macroeconomic discourse) and NOT "Pekerja & Pertanian Rakyat" (that bucket is SUBSTANTIVE labor-rights: upah minimum, mogok kerja, PHK massal, sengketa buruh, hak pekerja, petani-economy — NOT an individual's job-hunt anxiety). Test: is the post a SYSTEMIC labor/economic issue (policy, dispute, market data) or a PERSONAL career feeling / individual loker ad? Personal feeling / single ad → Lainnya. Mainstream-RSS labor reporting (mogok 2.406 pekerja Freeport, PHK pabrik tekstil, demо buruh upah) stays Pekerja & Pertanian Rakyat.
...
- KOMCAD / BELA NEGARA / KDMP STATE TRAINING PROGRAMS (added 2026-06-19 after audit#70 found 6 Pendidikan→Pemerintahan bleeds). State-policy training programs that LOOK like education but are actually government program rollouts → "Pemerintahan & Kebijakan", NOT "Pendidikan & SDM": Komcad (Komponen Cadangan) pelatihan semi-militer / wajib pelatihan kemiliteran, KDMP (Koperasi Desa Merah Putih) calon manajer wajib pelatihan Komcad / barak Komcad / pelatihan militer, Jambore dan Olimpiade Bela Negara, program bela negara di sekolah/desa, MPLS bela negara tingkat nasional, pelatihan kepemimpinan koperasi desa program Kementerian Koperasi UMKM, pelatihan PPPK Lapas / Penjaringan ASN-PNS sektoral, diklat struktural-fungsional pejabat. These are GOVERNMENT-PROGRAM rollouts using training as the delivery method — the news angle is the policy/program, not the curriculum/pedagogy. Test: would this post fit a Ministry-of-Defense / Ministry-of-Cooperatives / Kemendagri policy briefing? If yes → Pemerintahan. Pendidikan & SDM stays reserved for actual education content: sekolah/kampus/madrasah operations, kurikulum, beasiswa, akreditasi, rektor/dekan/kepala sekolah news, SPMB, asesmen siswa, ujian, lulus, juara siswa, kegiatan kelas, materi ajar.
  KDMP/KOMCAD PROGRAM-INCIDENT & CASUALTY NEWS (added 2026-06-25 after audit#77 found 12 bleeds, mostly Lingkungan→Pemerintahan + Lainnya→Pemerintahan). When a state-training program produces an INCIDENT — deaths/injuries during Latsarmil (latihan dasar militer) for SPPI / Kopdes Merah Putih recruits, Kemhan "evaluasi total" of the program after casualties, DPR Komisi I evaluation of training deaths, critique of the program's safety — route to "Pemerintahan & Kebijakan", NOT "Lingkungan & Bencana" (the deaths are not a natural disaster) and NOT "Lainnya". The casualty is news BECAUSE it indicts a government program — that makes it policy debate. Same dual-track logic as MBG: the program-as-policy angle (evaluasi, pertanggungjawaban, Kemhan/DPR response) → Pemerintahan; only if there's a named perpetrator + criminal penyidikan (e.g. komandan dijadikan tersangka atas kelalaian) does it cross into Hukum & Keadilan.
...
- MK (MAHKAMAH KONSTITUSI) JUDICIAL REVIEW (added 2026-06-24 after audit#74 found 10 Hukum→Pemerintahan bleeds). Posts about uji formil / uji materiil / gugatan ke MK terhadap UU atau program pemerintah (mahasiswa/guru/aktivis gugat MBG di MK, BEM uji formil UU Polri, dosen gugat UU Sisdiknas, koalisi sipil ajukan judicial review RUU XYZ, putusan MK terkait UU) → "Pemerintahan & Kebijakan", NOT "Hukum & Keadilan". MK is the CONSTITUTIONAL governance body — judicial review of legislation is POLICY-DISCOURSE, not active law-enforcement against named criminal subjects. Hukum applies only when a criminal-action verb (razia / penindakan / tersangka / penggeledahan / vonis pidana) acts on a named perpetrator. MK gugatan/judicial review = no perpetrator, no arrest verb → Pemerintahan.
- ENERGY SUPPLY CRISIS + MINISTERIAL POLICY RESPONSE (added 2026-06-24 after audit#74 found 18 Ekonomi→Pemerintahan bleeds from the PLN pemadaman / oligarki batu bara story). Power-outage / fuel-supply / DMO crisis stories that quote a MINISTER (ESDM Bahlil, Menteri BUMN) or PRESIDENT (Prabowo instruksi) responding to the crisis → "Pemerintahan & Kebijakan", NOT "Ekonomi & Bisnis", even when the framing references commodity prices, oligarki batu bara, ekspor batu bara, kebijakan ekspor, korporasi tambang. The crisis IS the policy issue — when the news is the government's posture (minister statement on supply, presidential instruction on DMO, kritik kebijakan ekspor, "paradoks ESDM"), the angle is governance not market. Ekonomi & Bisnis stays for pure market commentary (harga batu bara naik/turun, saham PTBA/Adaro, dividen perusahaan tambang) without ministerial action as the news event. Test: is the news a MINISTERIAL or PRESIDENTIAL action/statement on the supply crisis? If yes → Pemerintahan.
- AUDIT#78 traps (added 2026-06-26, from a 3,261-post past-2d sweep — 215 corrections):
    * DPRD HAK ANGKET / PANSUS legislative-oversight inquiry into an official's alleged misconduct (e.g. "Sidang Hak Angket DPRD Gowa" surfacing a Bupati's affair/miras allegations) → "Pemerintahan & Kebijakan", NOT "Hukum & Keadilan". Same logic as MK judicial review: legislative oversight ≠ criminal proceeding. Route to Hukum only when a police/court criminal process (penyidikan / tersangka / vonis) acts on a named perpetrator.
    * DISASTER / ACCIDENT ABROAD whose Indonesian angle is WNI SAFETY / Kemlu consular follow-up (gempa luar negeri "3 WNI selamat", tabrakan kapal nelayan di Busan "2 WNI hilang", LPG-carrier collision) → "Lingkungan & Bencana", NOT "Konflik & Geopolitik". Konflik is for armed conflict / geopolitics / Palestina / solidaritas-umat — not every overseas incident that merely mentions WNI.
    * WORLD CUP 2026 / FOOTBALL coverage stays "Lainnya" even with an incidental keyword — naturalisasi / pemalsuan dokumen pemain (peripheral fraud mention), US-Iran or anti-kolonial geopolitical BACKDROP to a match, or match-schedule / nobar / jadwal listings. Strip the keyword: if the subject is the match / team / tournament, it is sports → Lainnya, NOT Hukum / Konflik / Lingkungan.
    * EDUCATION content keeps getting dumped in Lainnya → route to "Pendidikan & SDM": MPLS school-orientation programs (lintas-jenjang TK/SD/SMP/SMA), student academic-olympiad material (OSN / OSN-K pembahasan soal IPA/MTK SMP/SMA), exam questions + answer keys (soal sumatif/STS + kunci jawaban PAI/tematik SD), teacher-welfare disbursement (TPG / Tunjangan Profesi Guru Non-ASN cair). These are substantive education-sector content, not off-topic.
  GENERAL (audit#78): the classifier over-defaults classifiable posts to "Lainnya" (the single largest error class this sweep — ~60 Lainnya→real-group fixes). When a post has a clear single-group subject — a crime case (arrest / tersangka / penyekapan / penganiayaan), an accident / earthquake, an education item, a government-bureaucracy action (mutasi / pelantikan / infrastruktur / bansos), a mosque / Islamic-observance event — PREFER that group over Lainnya. Reserve Lainnya for genuinely off-taxonomy content (pure sports / entertainment / celebrity, song lyrics, foreign-language spam, personal trivia, routine service-PR like SIM Keliling jadwal).
- AUDIT#79 (added 2026-06-27) — PUBLIC-HEALTH / DISEASE content → "Kesehatan & Kehidupan", NOT "Sosial & Keluarga" or "Toleransi & Lintas-Iman". Disease epidemiology/surveillance (data kasus HIV/TBC/DBD, tren penularan, surveilans Dinkes), disease-control regulation (Raperda/Perda TBC–HIV/AIDS, kebijakan pengendalian penyakit), and immunization/vaccination drives (imunisasi anak, kampanye SI SALI) belong in Kesehatan & Kehidupan EVEN WHEN framed via masyarakat/keluarga/anak (the demographic does not make it Sosial & Keluarga) or carried out by a faith-group/community actor (a Catholic-youth or ormas endorsement of an immunization program is a HEALTH story, NOT Toleransi — Toleransi requires interfaith dialogue/moderation as the actual subject). Sosial & Keluarga stays for family dynamics / child-protection / domestic violence / social-welfare disputes.
- AUDIT#80 (added 2026-06-29, 7d sweep, 279 corrections) — "Ekonomi & Bisnis" requires REAL economic/business substance, NOT merely a Rupiah figure. Culinary / lifestyle / entertainment / sports / personal posts that just mention money are NOT Ekonomi: heritage-kuliner features (Limun Badak), restaurant/menu promos (12 varian pizza), film box-office takings ("630rb penonton / investasi Rp1.7T"), "perputaran ekonomi Rp4T" around a World Cup match, personal shopping / antrean-donat anecdotes → route by the DOMINANT subject (usually "Lainnya"; a charity / feel-good giveaway → "Inspirasi & Kisah Pribadi"). Course-title trap: a student post about the "Perekonomian Indonesia" COURSE (tuton / nilai / tugas) → "Pendidikan & SDM", not Ekonomi. Reserve Ekonomi & Bisnis for markets / IHSG / forex / harga komoditas, corporate finance / dividen, UMKM development, and macro / business-policy discourse. (Same sweep: the two MOST over-used buckets remain "Lainnya" and "Pemerintahan & Kebijakan" — a government SPEAKER/co-host does not make a post governance; route by the actual subject.)
- AUDIT#81 (added 2026-06-30, 7d sweep, 167 corrections) — three rule-absent patterns:
    (a) THEMED NATIONAL-DAY COMMEMORATIVE GREETING routes by the DAY'S theme, NOT the issuing government agency. A bare Hari Keluarga Nasional / HARGANAS greeting (#HariKeluargaNasional / #AyahWajibHadir / "Keluarga Harmonis, Bangsa Kuat") posted by Imigrasi / Lapas / Pemkab / Kanwil Kemenkumham / Kemendukbangga is about FAMILY (parental roles, ketahanan keluarga) → "Sosial & Keluarga", NOT "Pemerintahan & Kebijakan" — the hosting office is incidental, there is no policy/bureaucracy subject. (Generalizes: a national-day ucapan carries the day's theme, not its sender's sector. Largest single cluster this sweep — 13/13.)
    (b) ZAKAT / INFAQ / SEDEKAH / WAKAF collection & distribution by BAZNAS / LAZ / UPZ / Dompet Dhuafa (penyaluran zakat ke fakir/miskin/mustahik, #zakatinfaksedekah) → "Aqidah & Ibadah" (it is ibadah maliyah / faith-based almsgiving), NOT "Ekonomi & Bisnis" (the Rupiah amount is incidental, there is no market/UMKM/investment subject) and NOT "Lainnya". (Distinct from the FOREIGN-GOVERNANCE rule above where MALAYSIAN state-zakat → Lainnya; Indonesian zakat administration is religious-practice content.)
    (c) HAJJ / UMRAH pilgrimage coverage → "Aqidah & Ibadah" EVEN WHEN framed through aviation / visa / logistics (kepulangan jamaah haji charter flight, jamaah umrah tertahan visa, "X jamaah diterbangkan ke Madinah", penyelenggaraan ibadah haji) — the ibadah is the dominant subject, the flight/visa detail is secondary; do NOT dump these in "Lainnya".
- AUDIT#82 (added 2026-07-02, 7d sweep, 296 corrections) — two KEYWORD-FALSE-POSITIVE classes where the classifier grabs a group from a surface token instead of the DOMINANT subject (reinforces the "SEMANTIC meaning, not surface keyword matches" rule for the two groups it most often trips on):
    (a) PATOLOGI SOSIAL DIGITAL requires ACTUAL judi-online / pinjol / narkoba as the dominant SUBJECT — NOT a post that merely contains the tokens "utang" / "hutang" / "judi" / "narkoba". Personal debt-curhat ("utang budi", "lunas cicilan", generic money stress / gaji-habis venting), gambling-as-metaphor/idiom, song lyrics, sermon mentions, or off-topic posts that happen to carry these words → route by the DOMINANT subject ("Lainnya", or "Ekonomi & Bisnis" for genuine personal-finance/KUR content, or "Inspirasi" for a bangkit-dari-utang testimonial). Reserve Patologi Sosial Digital for judol/online-gambling sindikat, pinjol/pinpri illegal-lending, and narkoba trafficking/abuse as the ACTUAL topic. (Biggest new error class this sweep — 32 Patologi→Lainnya. NOTE the converse still holds: genuine judol/pinjol/narkoba misfiled in Ekonomi/Hukum/Lainnya DOES belong in Patologi.)
    (b) HUKUM & KEADILAN requires an actual crime / police-court legal process / real case — NOT a post that merely contains a crime keyword ("perkosa", "bunuh", "aniaya", "maling", "bacok") used as vulgar slang, hyperbole, fiction/film synopsis, or personal venting on X with NO real case → "Lainnya". (A named police/court process acting on a real perpetrator stays Hukum; a movie plot or an angry tweet using "perkosa" as an insult does not.)
...
- OPM / Papuan armed-conflict operations — "Marinir TNI AL rebut markas OPM", "Kontak tembak Papua Pegunungan", "Pasukan ditembak KKB", "Genosida Papua kolonialisme RI", "MRP Korowai ketertinggalan kawasan konflik" → "Konflik & Geopolitik" (military operations against named insurgent groups, not Hukum, not Pemerintahan). AUDIT#84 refinement (added 2026-07-06, 7d sweep, 205 corrections): this ALSO covers a KKB/OPM/TPNPB armed attack that KILLS people or DESTROYS aircraft/vehicles/property — e.g. the Yahukimo attack where separatists shot a pilot and BURNED the AMA plane. Such an event → "Konflik & Geopolitik", NOT "Lingkungan & Bencana" (it is a deliberate armed attack by a named insurgent group, NOT an aviation accident / natural disaster) and NOT "Hukum & Keadilan". The presence of a burned plane / casualties does not make it a Lingkungan "kecelakaan" when the cause is an armed-separatist attack.
