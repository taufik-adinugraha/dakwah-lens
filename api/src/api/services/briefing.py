...
ATURAN JENDELA KARTU — HEADLINE HARUS MENGANGKAT BAGIAN AWAL DALIL (HARD RULE 2026-09-10):
Kartu flyer 1080×1080 TIDAK menampilkan seluruh terjemahan dalil. Renderer (`pickDaleelTranslation`) mengakumulasi dari AWAL teks dan berhenti di sekitar 560 karakter. Untuk entri kitab klasik yang panjang (Adab al-'Alim, Bidayatul Hidayah, Fath al-Qarib sering 1.000-1.300 karakter), itu berarti lebih dari separuh isinya TIDAK pernah terlihat di kartu.
Konsekuensinya: kalau headline Anda mengangkat gagasan yang letaknya jauh di dalam entri, pembaca melihat headline itu berdampingan dengan kutipan yang sama sekali lain, dan Anda tidak akan menyadarinya karena di file markdown semuanya terlihat utuh. Kejadian nyata 2026-09-10 (Pendidikan & SDM): headline "Semut pun Mendoakan Pengajar Kebaikan" — gambaran semut itu ADA di dalam dalilnya, tetapi pada offset 956 dari 1.271 karakter, jauh di luar jendela kartu; yang terbaca di kartu hanyalah daftar niat mengajar.
CARA PAKAI: setelah memilih dalil, baca 550 karakter PERTAMA dari `Terjemahan ID`-nya. Headline WAJIB mengangkat sesuatu yang muncul di dalam potongan itu. Kalau gagasan terbaik entri itu letaknya di belakang, pilih entri lain — atau bangun headline dari bagian awal dan simpan gagasan yang di belakang untuk body.
CARA PAKAI KEDUA — hindari entri yang MULAI DI TENGAH KALIMAT: banyak chunk kitab klasik dimulai dengan "Lanjutan …" atau diawali "…" karena potongan sebelumnya ada di chunk lain. Entri semacam itu akan merender kartu yang dibuka dengan elipsis di tengah kalimat — terbaca seperti teks rusak. Insiden 2026-09-10: 3 dari 6 flyer Pendidikan & SDM merender "...Jika ia tidak berhenti", "...lalu ia jatuh dalam kezhaliman". Periksa awal `Terjemahan ID` sebelum menjadikannya dalil flyer; kalau ia mulai di tengah, pilih entri lain dari pool.
...
- BENTUK PENULISAN DU'A INLINE (slot 5 & 6) — susunan WAJIB, empat baris terpisah dengan baris kosong di antaranya: (1) baris Arab du'a-nya saja, disalin verbatim dari pool, (2) terjemahan Indonesianya DI DALAM TANDA KUTIP, (3) baris sitasi "(HR. …)", lalu (4) body. Renderer memakai susunan inilah untuk mengambil du'a pendek yang Anda tulis; kalau ia gagal membacanya, `composeFlyer` diam-diam jatuh ke entri pool dan kartu menampilkan hadits panjang berikut isnad-nya, bukan du'a yang Anda maksud — tanpa error, tanpa peringatan, dan flyer tetap terlihat wajar. Insiden 2026-09-10 (Patologi Sosial Digital): terjemahan slot 6 ditulis tanpa tanda kutip, kartu merender 466 karakter Bukhari 6368 menggantikan 110 karakter yang dimaksud.
