  ...
  return (
    <section className="rounded-2xl border border-fuchsia-200/70 bg-gradient-to-br from-fuchsia-50 via-white to-violet-50 p-5 shadow-sm ring-1 ring-fuchsia-200/40 sm:p-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <Link
          href="/flyers/new"
          className="inline-flex shrink-0 items-center gap-1.5 rounded-full bg-fuchsia-700 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-fuchsia-800"
        >
