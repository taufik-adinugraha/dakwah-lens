 ...
 *
 *   Markdown → /api/insights-brief/{id}/markdown (raw summary_md)
 *   Text     → /api/insights-brief/{id}/text (markdown-stripped plain text)
      ...
      {open && (
        <>
          ...
          >
            ...
            <DownloadLink
              href={`/api/insights-brief/${briefId}/markdown`}
