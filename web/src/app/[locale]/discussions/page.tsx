        ...
        <div className="mt-10">
          <DiscussionsBoard
            ...
            labels={{
              ...
              segmentSpiritual: t("discussions_segment_spiritual"),
              segmentFamily: t("discussions_segment_family"),
              segmentYouth: t("discussions_segment_youth"),
              segmentJustice: t("discussions_segment_justice"),
