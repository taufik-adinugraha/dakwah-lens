 ...
 *
 * Anchored to Sunday-00:00 WIB so all three quota meters on the
 * dashboard (flyer, draft kajian, kajian) reset together. Same
 * boundary the flyer quota uses — see [[currentWeekStartUtc]] in
 * lib/user-flyer/quota.ts for the WIB offset arithmetic.
 * ───────────────────────────────────────────────────────────── */
...
/** Counts kajian (deliverables) created since this week's Sunday-00:00 WIB.
 *  Same boundary as [[getBriefsThisWeek]] and the flyer quota, so the
 *  three dashboard chips all roll over together. */
